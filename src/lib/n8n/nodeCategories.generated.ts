...
// Updated for n8n v2.2+ (January 2026)
// Source: GitHub n8n master + manual verification
// Total: 632+ validated nodes
// AI Tools: 125 total (14 LangChain + 111 service-specific)
// New in v2.x: ModelSelector, ToolExecutor, RerankerCohere, EmbeddingsLemonade
// FlowEngine Custom Nodes: flowEngine, CUSTOM.flowEngineLlm, sendEmailTest
// Session ID Node: n8n-nodes-flowengine-session-id.flowEngineSessionId
// Data Standardize & Clean Node: n8n-nodes-flowengine-data-standardize-clean.dataCleaner

export const NODE_CATEGORIES_BY_USAGE = {
  triggers: [
  ...
  regularNodes: [
    ...
    "CUSTOM.flowEngine",
    "CUSTOM.sendEmailTest",
    "n8n-nodes-flowengine-session-id.flowEngineSessionId",
    "n8n-nodes-flowengine-data-standardize-clean.dataCleaner",
  ...
  aiTools: [
    ...
    "n8n-nodes-base.apiTemplateTool",
    ...
    "n8n-nodes-base.googleFirestoreTool",
    "n8n-nodes-base.googleRealtimeDatabaseTool",
    ...
    "n8n-nodes-base.quickBooksOnlineTool",
...
export const NODE_DESCRIPTIONS = {
  trigger: 'Starts a workflow, connects via "main"',
  regularNode: 'Standalone action node, connects via "main"',
  aiAgent: 'AI agent, needs ai_languageModel + ai_memory + optional ai_tool connections',
  aiModel: 'Language model, connects to AI agent via "ai_languageModel"',
  aiMemory: 'Conversation memory, connects to AI agent via "ai_memory"',
  aiTool: 'Tool for AI agents, connects via "ai_tool"',
  aiEmbedding: 'Text embeddings, connects to vector store via "ai_embedding"',
  aiVectorStore: 'Vector database, can connect as ai_tool to AI agent',
};

// Flattened array of all valid node types (for backwards compatibility)
export const ALL_NODES: ReadonlyArray<string> = [
  ...NODE_CATEGORIES_BY_USAGE.triggers,
  ...NODE_CATEGORIES_BY_USAGE.regularNodes,
  ...NODE_CATEGORIES_BY_USAGE.aiAgents,
  ...NODE_CATEGORIES_BY_USAGE.aiModels,
  ...NODE_CATEGORIES_BY_USAGE.aiMemories,
  ...NODE_CATEGORIES_BY_USAGE.aiTools,
  ...NODE_CATEGORIES_BY_USAGE.aiEmbeddings,
  ...NODE_CATEGORIES_BY_USAGE.aiVectorStores,
  ...NODE_CATEGORIES_BY_USAGE.aiOutputParsers,
  ...NODE_CATEGORIES_BY_USAGE.aiTextSplitters,
  ...NODE_CATEGORIES_BY_USAGE.aiDocumentLoaders,
];

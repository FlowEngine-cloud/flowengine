/**
 * Proxy: POST /api/flowengine/instances/[instanceId]/terminal
 * Executes a SQL command against the instance's PostgreSQL database.
 */
...
function handleError(err: unknown) {
  ...
  console.error('[flowengine/instances/terminal] Error:', msg);
  return NextResponse.json(
...
export async function POST(
  ...
  try {
    ...
    const result = await client.executeTerminal(instanceId, command);

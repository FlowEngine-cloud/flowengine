/**
 * Proxy: GET /api/flowengine/instances/[instanceId]/credentials
 * Fetches PostgreSQL database credentials for a FlowEngine-hosted n8n instance.
 */
...
function handleError(err: unknown) {
  ...
  console.error('[flowengine/instances/credentials] Error:', msg);
  return NextResponse.json(
...
export async function GET(
  ...
  try {
    ...
    const result = await client.getInstanceCredentials(instanceId);
